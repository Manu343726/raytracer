...
Job* JobQueue::pop()
{
    ...
    if(top <= bottom)
    {
        ...
        spdlog::trace(
            "JobQueue::pop() returns {} (top: {}, bottom: {})",
            job->id(),
            top % _jobs.size(),
            bottom % _jobs.size());
        return job;
    ...
    else
    {
        ...
        spdlog::trace(
            "JobQueue::pop() failed (queue empty. top: {}, bottom: {})",
            top,
            bottom);
        return nullptr;
    }
...
Job* JobQueue::steal()
{
    ...
    if(top < bottom)
    {
        ...
        {
            spdlog::trace(
                "JobQueue::steal(this: {}) returns {} (top: {}, bottom: {})",
    ...
    else
    {
        // The queue is empty
        spdlog::trace(
            "JobQueue::steal(this: {}) failed (queue empty. top: {}, bottom: {})",
            reinterpret_cast<void*>(this),
            top,
            bottom);
        return nullptr;
